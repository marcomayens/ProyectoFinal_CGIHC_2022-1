...
int main()
{
	...
	Model caja("resources/objects/Caja/caja.obj");
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		model = glm::translate(glm::mat4(1.0f), glm::vec3(-50.0f, 0.0f, 50.0f));
		model = glm::rotate(model, glm::radians(90.0f), glm::vec3(0.0f, -1.0f, 0.0f));
		staticShader.setMat4("model", model);
		sillon.Draw(staticShader);


		model = glm::translate(glm::mat4(1.0f), glm::vec3(100.0f, 0.0f, 50.0f));
		model = glm::rotate(model, glm::radians(90.0f), glm::vec3(0.0f, -1.0f, 0.0f));
		staticShader.setMat4("model", model);
